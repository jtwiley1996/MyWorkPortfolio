   ...
   return (
    <div className='h-[100px] dark:bg-white text-gray-400 max-w-[1200px] mx-auto flex justify-between items-center'>
      ...
      <ul className='hidden md:flex font-bold'>
          ...
          <li className='p-5 text-shadow hover:font-bold'><Link to="/Work" className={currentPage === '/Work' ? 'nav-link active primary-color' : 'nav-link'}>Portfolio</Link></li>
      ...
      <div className={nav ? 'z-10 fixed h-full left-0 top-0 w-[60%] bg-[#202121] ease-in-out duration-500' : 'fixed left-[-100%]'}>
          ...
          <ul className='p-8 text-2xl font-bold'>
              ...
              <li className='p-2 text-shadow hover:font-bold'><Link to="/Work" className={currentPage === '/Work' ? 'nav-link active primary-color' : 'nav-link'}>Portfolio</Link></li>
